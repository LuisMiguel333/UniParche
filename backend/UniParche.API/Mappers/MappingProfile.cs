...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        CreateMap<CreateUserRequest, User>()
            ...
            .ForMember(dest => dest.Carrer_name, opt => opt.MapFrom(src => src.CarrerName))
            ...
            .ForMember(dest => dest.profile_picture_url, opt => opt.Ignore())
            .ForMember(dest => dest.register_time, opt => opt.Ignore())
        ...
        CreateMap<UpdateUserRequest, User>()
            ...
            .ForMember(dest => dest.Carrer_name, opt => opt.MapFrom(src => src.CarrerName))
            .ForMember(dest => dest.semester, opt => opt.MapFrom(src => src.Semester))
            .ForMember(dest => dest.profile_picture_url, opt => opt.MapFrom(src => src.ProfilePictureUrl))
            .ForMember(dest => dest.Id, opt => opt.Ignore())
            .ForMember(dest => dest.password_hash, opt => opt.Ignore())
        ...
        CreateMap<User, UserResponse>()
            ...
            .ForMember(dest => dest.Email, opt => opt.MapFrom(src => src.email))
            .ForMember(dest => dest.CarrerName, opt => opt.MapFrom(src => src.Carrer_name))
            .ForMember(dest => dest.Semester, opt => opt.MapFrom(src => src.semester))
            .ForMember(dest => dest.ProfilePictureUrl, opt => opt.MapFrom(src => src.profile_picture_url))
            .ForMember(dest => dest.RegisterDate, opt => opt.MapFrom(src => src.register_time))
            .ForMember(dest => dest.UniversityId, opt => opt.MapFrom(src => src.UniversityId))
        ...
        CreateMap<Comment, CommentResponse>()
            ...
            .ForMember(dest => dest.UserId, opt => opt.MapFrom(src => src.UserId))
            .ForMember(dest => dest.UserName, opt => opt.MapFrom(src => src.User != null ? src.User.user_name : string.Empty))
            .ForMember(dest => dest.UserProfilePictureUrl, opt => opt.MapFrom(src => src.User != null ? src.User.profile_picture_url : string.Empty))
            .ForMember(dest => dest.PostId, opt => opt.MapFrom(src => src.PostId))
            .ForMember(dest => dest.CreatedAt, opt => opt.MapFrom(src => src.CreatedAt))
